...
Mobile.setText(findTestObject('andro jual/formJual/namaProduk'), 'drone menarik', 0)

Mobile.setText(findTestObject('andro jual/formJual/hargaProduk'), '1450000', 0)
...
Mobile.setText(findTestObject('andro jual/formJual/Deskripsi'), 'drone canggih bisa terbang', 0)

Mobile.tap(findTestObject('andro jual/formJual/buttonTerbitkan'), 0)

Mobile.verifyElementVisible(findTestObject('andro jual/formJual/iconKamera'), 0)
