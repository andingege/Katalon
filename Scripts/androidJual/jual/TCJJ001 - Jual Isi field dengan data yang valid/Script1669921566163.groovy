...
Mobile.setText(findTestObject('andro jual/formJual/namaProduk'), 'Drone', 0)

Mobile.setText(findTestObject('andro jual/formJual/hargaProduk'), '2000000', 0)
...
Mobile.setText(findTestObject('andro jual/formJual/Deskripsi'), 'Drone Canggih Serbaguna', 0)
...
Mobile.verifyElementVisible(findTestObject('andro jual/daftarJualSaya/daftarJualSaya'), 0)
