...
WebUI.setText(findTestObject('profile/nama'), 'Doni Damara')

WebUI.setText(findTestObject('profile/Alamat'), 'Jekardah')

WebUI.setText(findTestObject('profile/No Handphone'), '0123141')

WebUI.selectOptionByIndex(findTestObject('profile/Kota'), 0)
